#!/usr/bin/env python3
"""
Generate definitions from template.json
"""
import os
import sys
import json
...
def process_template(template_file, output_file):
    """Replace environmental variables in template.json and write to output file"""
...
def main():
    if len(sys.argv) != 3:
        print(
            "Usage: generate-from-template.py <template-file-or-dir> <output-file-or-dir>",
            file=sys.stderr,
        )
        sys.exit(1)
